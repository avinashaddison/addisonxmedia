  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-primary/10 via-background to-primary/5">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed" data-testid="text-about-description">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center" data-testid="text-story-title">
              Our Story
            </h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed mb-6" data-testid="text-story-paragraph-1">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed mb-6" data-testid="text-story-paragraph-2">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed" data-testid="text-story-paragraph-3">
      ...
      <section className="py-16 md:py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4" data-testid="text-values-title">
              Our Values
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {values.map((value, index) => {
              ...
              return (
                <Card key={index} className="p-6 md:p-8" data-testid={`card-value-${index}`}>
                  <div className="mb-4">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-md bg-primary/10">
                      <Icon className="h-6 w-6 text-primary" />
                    </div>
                  </div>
                  <h3 className="text-xl md:text-2xl font-semibold mb-3" data-testid={`text-value-title-${index}`}>
                    {value.title}
                  </h3>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center" data-testid="text-why-choose-title">
              Why Choose AddisonX Media?
            </h2>
            <div className="space-y-6">
              <Card className="p-6">
                <h3 className="text-xl font-semibold mb-3" data-testid="text-reason-title-0">
                  Local Expertise, Global Standards
                </h3>
                <p className="text-muted-foreground leading-relaxed" data-testid="text-reason-description-0">
                  We understand the Ranchi market intimately while applying international 
                  best practices to ensure your business stands out.
                </p>
              </Card>
              <Card className="p-6">
                <h3 className="text-xl font-semibold mb-3" data-testid="text-reason-title-1">
                  Comprehensive Solutions
                </h3>
                <p className="text-muted-foreground leading-relaxed" data-testid="text-reason-description-1">
                  From web development to social media marketing, we offer end-to-end 
                  digital services under one roof.
                </p>
              </Card>
              <Card className="p-6">
                <h3 className="text-xl font-semibold mb-3" data-testid="text-reason-title-2">
                  Proven Track Record
                </h3>
                <p className="text-muted-foreground leading-relaxed" data-testid="text-reason-description-2">
                  Our portfolio of successful projects and satisfied clients speaks to 
                  our commitment to delivering exceptional results.
                </p>
              </Card>
              <Card className="p-6">
                <h3 className="text-xl font-semibold mb-3" data-testid="text-reason-title-3">
                  Transparent Communication
                </h3>
                <p className="text-muted-foreground leading-relaxed" data-testid="text-reason-description-3">
